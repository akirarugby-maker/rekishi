...
export const NIHONSHI_EVENTS = [
  ...
  { year: 1392, label: "南北朝合一（足利義満）",       imp: 2, eraId: "muromachi" },
  ...
  { year: 1582, label: "本能寺の変",                  imp: 3, eraId: "sengoku" },
  ...
  { year: 1615, label: "大坂夏の陣・武家諸法度",       imp: 2, eraId: "edo" },
  { year: 1635, label: "参勤交代制定",                imp: 2, eraId: "edo" },
  { year: 1639, label: "鎖国（ポルトガル船禁止）",      imp: 2, eraId: "edo" },
  ...
  { year: 1866, label: "薩長同盟",                    imp: 2, eraId: "edo" },
